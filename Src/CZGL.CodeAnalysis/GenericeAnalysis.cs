...
namespace CZGL.CodeAnalysis
{
    ...
    public class GenericeAnalysis
    {
        ...
        /// <returns></returns>
        public string Analysis(Type _genericeType, bool isFullName = false)
        {
        ...
        /// <param name="isFullName">参数类型是否显示详细的名称，即显示详细的命名空间，FullName</param>
        /// <returns></returns>
        public string AnalysisName(Type _genericeType, bool isFullName = false)
        {
            if (!_genericeType.IsGenericType)
        ...
        /// <returns></returns>
        private string BuilderGenerice(Type genericType, bool first = true, bool isFullName = false)
        {
        ...
        /// <returns></returns>
        public string GetGenericeName(Type _genericeType, bool isFullName = false)
        {
