...
namespace CZGL.Reflect.Tests
{
    ...
    public class KeywordAnalysisTests
    {
        ...
        public void GetPropertydKeyword()
        {
            ...
            Assert.Equal(PropertyKeyword.RefReadonly, KeywordAnalysis.GetKeyword(g!));
            Assert.Equal(PropertyKeyword.StaticRefReadonly, KeywordAnalysis.GetKeyword(h!));
            Assert.Equal(PropertyKeyword.VirtualRefReadonly, KeywordAnalysis.GetKeyword(i!));
            Assert.Equal(PropertyKeyword.OvverideRefReadonly, KeywordAnalysis.GetKeyword(j!));
        }
        ...
        public void GetMethodKeyword()
        {
            ...
            Assert.Equal(MethodKeyword.RefReadonly, KeywordAnalysis.GetKeyword(g!));
            Assert.Equal(MethodKeyword.StaticRefReadonly, KeywordAnalysis.GetKeyword(h!));
            Assert.Equal(MethodKeyword.VirtualRefReadonly, KeywordAnalysis.GetKeyword(i!));
            Assert.Equal(MethodKeyword.OvverideRefReadonly, KeywordAnalysis.GetKeyword(j!));
        }
    }
}
