...
namespace CZGL.Roslyn
{
    ...
    public static class CodeSyntax
    {
        ...
        /// 创建编译器
        /// </summary>
        /// <param name="path">dll 生成位置</param>
        /// <param name="assemblyName">程序集名称</param>
        /// <returns></returns>
        public static CompilationBuilder CreateCompilation(string path,string assemblyName)
        {
            return new CompilationBuilder(path,assemblyName);
        }
